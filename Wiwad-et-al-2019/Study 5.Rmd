...
setwd("/Users/dylanwiwad/Dropbox/Work/Dissertation/Scale IRT Pilot/Predictive Validity Summer 2018/")
...
summary(lm(z.dict.give~inegal+z.age+z.gender+z.inc+z.ideol, data=data))
```
...
## Separability of constructs analysis from westfall and Yarkoni

```{r}
lvs='
  seis =~ tol1 + tol2 + tol3 + tol4 + tol5
  bjw =~ bjw1+bjw2+bjw3+bjw4+bjw5+bjw6+bjw7+bjw8+bjw9+bjw10+bjw11+bjw12+bjw13+bjw14+bjw15+bjw16+bjw17+bjw18
  sdo =~ sdo1+sdo2+sdo3+sdo4+sdo5+sdo6+sdo7+sdo8+sdo9+sdo10+sdo11+sdo12+sdo13+sdo14+sdo15
  ejst =~ esjt1+esjt2+esjt3+esjt4+esjt5+esjt6+esjt7+esjt8+esjt9+esjt10+esjt11+esjt12+esjt13+esjt14+esjt15+esjt16+esjt17
  pwe =~ pwe1+pwe2+pwe3+pwe4+pwe5+pwe6+pwe7+pwe8+pwe9+pwe10+pwe11+pwe12+pwe13+pwe14+pwe15+pwe16+pwe17+pwe18+pwe19
  inegal =~ inegal1+inegal2+inegal3+inegal4+inegal5+inegal6+inegal7+inegal8
  dict.give ~ seis + bjw + sdo + ejst + pwe + inegal
'

library(lavaan)

fit.lvs=cfa(lvs, data=data, sample.nobs = nrow(data))

# display summary output
summary(fit.lvs, fit.measures=TRUE, standardized=TRUE)
#get standardized variances
standardizedSolution(fit.lvs)

#get a visual of the path
library(semPlot)
semPaths(fit.lvs, what="est", layout="tree", title=TRUE, style="LISREL")
```
...
lvs='
  ...
  pwe =~ pwe1+pwe2+pwe3+pwe4+pwe5+pwe6+pwe7+pwe8+pwe9+pwe10+pwe11+pwe12+pwe13+pwe14+pwe15+pwe16+pwe17+pwe18+pwe19
  inegal =~ inegal1+inegal2+inegal3+inegal4+inegal5+inegal6+inegal7+inegal8
  redist =~ redist1+redist2+redist3+redist4
  dict.give ~ seis + bjw + sdo + ejst + pwe + inegal + redist + wvs + issp
'
